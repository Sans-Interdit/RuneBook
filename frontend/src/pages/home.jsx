    ...
    <div className="flex flex-col overflow-auto bg-primary-50">
      ...
      <div className="flex flex-col items-center px-6 py-16">
        ...
        <div className="grid w-3/4 grid-cols-1 gap-8 md:grid-cols-3">
          ...
          >
            <div className="p-8">
              ...
              <h3 className="mb-6 text-2xl font-bold text-center text-secondary-50">
                Les fondamentaux
              </h3>
              <div className="flex justify-center w-full">
                <span
                  className={`px-4 py-2 text-sm font-semibold rounded-full text-primary-50 bg-green-400`}
                >
                  Nouveau Joueurs
                </span>
              </div>
          ...
          >
            <div className="p-8">
              ...
              <div className="flex justify-center w-full">
                <span
                  className={`px-4 py-2 text-sm font-semibold rounded-full text-primary-50 bg-secondary-50`}
                >
                  Joueur Medium
                </span>
              </div>
          ...
          >
            <div className="p-8">
              ...
              <div className="flex justify-center w-full">
                <span
                  className={`px-4 py-2 text-sm font-semibold rounded-full text-primary-50 bg-red-400`}
                >
                  Joueur Confirmé
                </span>
              </div>
        ...
        <div className="flex items-center justify-center gap-3 mt-12">
          ...
          <div
            className="w-3 h-3 rounded-full bg-secondary-50 animate-pulse"
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-between p-8 border-2 rounded-2xl bg-background-50 border-primary-100/30">
            ...
            <p className="mb-6 text-lg leading-relaxed text-white font-text">
              Notre chatbot IA est conçu pour être bienveillant et pédagogue. Il
              adapte ses réponses à ton niveau et ne te submergera jamais
            ...
            <ul className="mb-8 space-y-5">
              ...
              <li className="flex items-center">
                ...
                <span className="text-white font-text">
                  Répond à toutes tes questions sans jugement
                </span>
              </li>
              <li className="flex items-center">
                <div className="flex items-center justify-center flex-shrink-0 w-6 h-6 mr-3 rounded-full bg-secondary-50">
                ...
                <span className="text-white font-text">
                  Disponible 24/7 pour t'accompagner
                </span>
              </li>
            </ul>
            <Link
          ...
          <div className="flex flex-col p-8 border-2 rounded-2xl bg-background-50 border-primary-100/30">
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="flex justify-end">
                <div className="max-w-xs p-4 rounded-lg bg-primary-100 text-primary-50">
                  <p className="text-sm font-text">
                    C'est quoi le farming et pourquoi c'est important ?
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-start">
                <div className="max-w-xs p-4 border-2 rounded-lg bg-background-50 border-secondary-50/30">
                  <p className="text-sm text-white font-text">
                    Le farming, c'est simplement tuer les petits monstres (les
                    sbires) pour gagner de l'or. C'est important car plus tu as
                    d'or, plus tu peux acheter d'objets puissants ! Veux-tu que
                    je t'explique comment bien farmer ?
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-start">
                <div className="max-w-xs p-4 border-2 rounded-lg bg-background-50 border-secondary-50/30">
                  <p className="text-sm text-white font-text">
                    Parfait ! Le secret c'est de donner le coup final aux
                    sbires. Attends que leur vie soit très basse avant de
                    frapper...
                  </p>
                </div>
              </div>
      ...
      <div className="flex flex-col items-center px-6 py-20 text-center">
        <div className="w-4/6 p-12 border-2 rounded-3xl bg-background-50 border-primary-100/30">
          ...
          <p className="max-w-2xl mx-auto mb-8 text-xl text-white font-text">
            Rejoins RuneBook et commence ton voyage d'apprentissage avec un
            guide bienveillant qui ne te submergera jamais d'informations.
          </p>
          <Link
            to="/inscription"
