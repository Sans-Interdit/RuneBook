    ...
    <div className="flex flex-col overflow-auto bg-primary-50">
      <div className="flex items-center justify-center flex-1 p-8">
        <div className="w-full max-w-md mb-20 space-y-4 text-center text-white">
          ...
          <p>
            Les mots de passe sont hachés et l&apos;accès aux bases de données
            est sécurisé, mais aucun système n&apos;est infaillible.
          </p>

          <h2 className="text-lg font-semibold">4. Partage des données</h2>
          <p>
            Aucune donnée n&apos;est partagée sauf obligation légale ou
            judiciaire.
          </p>
