  ...
  const mapPoints = [
    {
      id: "heimerdinger",
      name: "Heimerdinger",
      image: "/assets/heimerdinger.webp",
      position: { left: "59%", top: "52%" },
      description:
        "L'excentrique professeur Cecil B. Heimerdinger est l'un des inventeurs les plus novateurs et les plus estimés que le monde ait jamais connus. Membre le plus ancien du Conseil de Piltover, il a été témoin des excès et des dérives de la soif de progrès incessante de la ville. Malgré tout, ce brillant scientifique et enseignant est resté fidèle à sa vocation : mettre ses inventions originales au service de l'amélioration du quotidien.",
    },
    {
      id: "shen",
      name: "Shen",
      image: "/assets/shen.webp",
      position: { left: "73%", top: "17%" },
      description:
        "Parmi les mystérieux guerriers ioniens connus sous le nom de Kinkou, Shen est leur chef, l'Œil du Crépuscule. Il aspire à demeurer libre de toute confusion émotionnelle, de tout préjugé et de tout ego, et chemine sur la voie invisible du jugement impartial entre le monde spirituel et le monde physique. Chargé de maintenir l'équilibre entre eux, Shen manie des lames d'acier et d'énergie arcanique contre quiconque oserait le menacer.",
    },
    {
      id: "leblanc",
      name: "Leblanc",
      image: "/assets/leblanc.webp",
      position: { left: "47%", top: "31%" },
      description:
        "Mystérieuse même pour les autres membres de la cabale de la Rose Noire, LeBlanc n'est qu'un nom parmi tant d'autres pour cette femme à la peau pâle qui manipule les personnes et les événements depuis les origines de Noxus. Grâce à sa magie de duplication, la sorcière peut apparaître à n'importe qui, n'importe où, et même être à plusieurs endroits à la fois. Toujours en train de comploter dans l'ombre, les véritables motivations de LeBlanc sont aussi impénétrables que son identité changeante.",
    },
    {
      id: "morgana",
      name: "Morgana",
        ...
        {mapPoints.map((point) => (
          ...
          >
            <img
              ...
              src={point.image}
              alt={point.name}
              className="z-0 object-cover w-[12vh] h-auto aspect-square transition-transform duration-200 border-4 rounded-full cursor-pointer border-secondary-50 hover:scale-110"
              loading="lazy"
            />
            ...
            {hoveredId === point.id && (
              <div className="absolute z-10 p-4 ml-4 -translate-y-1/2 border-4 rounded-lg shadow-xl w-[360px] bg-background-50 left-full top-1/2 border-secondary-50">
                ...
                <p className="text-sm text-gray-50">{point.description}</p>
              </div>
            )}
          </Link>
        ))}
