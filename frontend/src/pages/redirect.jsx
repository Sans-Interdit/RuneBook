...
export default function Redirect() {
  ...
  return (
    <div className="flex flex-1 bg-primary-50">
      <div
        className="flex items-center justify-center flex-1 h-full p-6 bg-center bg-cover"
        style={{
          backgroundImage: `url('/assets/void.webp')`,
        }}
      >
        <div className="max-w-md p-8 text-center border-2 rounded-2xl bg-primary-50 border-secondary-50/30">
          ...
          <p className="mb-6 text-white font-text">
            Perdu dans le néant ? Redirection en cours...
          </p>
